...
class TempSens(resource.ObservableResource):
    #Getting the temperature of pi's sensor and sending it back
    ...
    async def render_get(self, request):
        ...
        temp_str = "Temperature of sensor: " + str(temp)
        
        payload = temp_str.encode('ascii')
...
class HelloWorld(resource.ObservableResource):
...
def main():
    ...
    root.add_resource(['temp'], TempSens())
